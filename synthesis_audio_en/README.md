...
* Read the paragraphs of text from the S3 bucket and folder `text_paragraphs`
* Use AWS Polly to generate an audio file in English
* Save the audio mp3 file in S3 bucket and folder `text_audios` (use the same file name and change extension to .mp3)
...
* Create a CSV file with your AWS credentials and save it inside a folder called `secrets` inside `synthesis_audio_en`
